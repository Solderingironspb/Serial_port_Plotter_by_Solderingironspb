# Serial port Plotter 1.2 by Solderingironspb
...
### Последние изменения:
#### v1.2 
* Теперь ось X - это не точки, а время.
* Переделана запись формата *.csv
* Добавлен маркер значений на графике при движении мыши
* Добавлена функция сохранения/чтения слепка графика
#### v1.1 
